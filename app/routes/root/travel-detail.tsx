...
import type {Route} from "../../../.react-router/types/app/routes/root/+types/travel-detail";
...
const TravelDetail = ({loaderData}: Route.ComponentProps) => {
    ...
    const {
        name, duration, budget, interests, estimatedPrice, travelStyle, groupType, country,
        itinerary, bestTimeToVisit, weatherInfo, description
    } = tripData || {};
            ...
            <div className="travel-div">
                ...
                <section className="container wrapper-md">
                    ...
                    <section className="title">
                        <article>
                            <h3>{duration}-Day {country} {travelStyle} Trip</h3>
