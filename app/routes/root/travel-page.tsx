import { ButtonComponent } from '@syncfusion/ej2-react-buttons/src/button'
...
const FeaturedDestinations = ({ containerClass = '', bigCard = false, rating, title, activityCount, bgImage }: DestinationProps) => (
        ...
        <main className="flex flex-col">
            ...
            <section className="pt-20 wrapper flex flex-col gap-10 h-full">
                <Header
                    ...
                    description="Discover the world's most popular destinations in the world"
                />
            ...
            <section
                id="trips"
                className="py-20 wrapper flex flex-col gap-10"
            >
                <Header
                    title="Handpicked Trips"
                    description="Explore our curated collection of amazing travel experiences"
                />
