...
export const user = {name: 'Arief'}

export const dashboardStats = {
  totalUsers: 12450,
  usersJoined: { currentMonth: 124, lastMonth: 150 },
  totalTrips: 3210,
  tripsCreated: { currentMonth: 168, lastMonth: 180 },
  userRole: { total: 12, currentMonth: 2, lastMonth: 1 },
}
